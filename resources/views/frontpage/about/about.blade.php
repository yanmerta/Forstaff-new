                ...
                <div class="col-lg-12">
                    <div class="about-content">
                        <div class="section-title text-center">
                            <h3 class="sub-title wow pixFadeUp">Tentang Kami</h3>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="team-member wow pixFadeRight" data-wow-delay="0.3s">
                        <div class="member-avater"> <img src="https://www.forstaff.id/assets/media/team/dylan-merigue.jpg"
                        ...
                        <div class="team-info">
                            <h3 class="name">Dylan Meringue</h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-member wow pixFadeRight" data-wow-delay="0.5s">
                        <div class="member-avater"> <img src="https://www.forstaff.id/assets/media/team/lance-bogrol.jpg"
                                alt="Lance Bogrol" title="Lance Bogrol" width="470" height="495">
                            <ul class="member-social">
                                <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                                <li><a href="#"><i class="fab fa-linkedin-in"></i></a></li>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-member wow pixFadeRight" data-wow-delay="0.7s">
                        <div class="member-avater"> <img src="https://www.forstaff.id/assets/media/team/stave-imanuel.jpg"
                                alt="Stave Imanuel" title="Stave Imanuel" width="470" height="495">
                            <ul class="member-social">
                                <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                                <li><a href="#"><i class="fab fa-linkedin-in"></i></a></li>
                        ...
                        <div class="team-info">
                            <h3 class="name">Stave Imanuel</h3>
                            <h4 class="job">UI/UX designer</h4>
                        </div>
                    </div>
                </div>
            </div>
