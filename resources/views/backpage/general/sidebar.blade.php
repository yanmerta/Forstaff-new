    ...
    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
        ...
        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
            ...
            <div class="menu-item here show menu-accordion">
                <a class="menu-link" href="{{ route('admin.admin.dashboard') }}" title="Dashboard"
            ...
            <div class="menu-item">
                <a class="menu-link" href="{{ route('frontpage.beranda') }}" title="See Website"
                    data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                    <span class="menu-icon">
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('admin.home.index') }}" title="Home"
            ...
            <div class="menu-item">
                <a class="menu-link" href="{{ route('admin.syarat.index') }}" title="Data Admin"
                    data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                    data-bs-placement="right">
                    <span class="menu-icon">
                        <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                    ...
                    <span class="menu-title">Syarat</span>
                </a>
            </div>
            <div class="menu-item">
                <a class="menu-link" href="{{ route('admin.kebijakan.index') }}" title="Data Admin"
                    data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                    data-bs-placement="right">
                    <span class="menu-icon">
                        <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('admin.footer_informasi.index') }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('admin.footer_kebijakan.index') }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Syarat dan Kebijakan</span>
                        </a>
                    </div>
                </div>
            </div>
            <div class="menu-item">
                <a class="menu-link" href="{{ route('admin.team.index') }}" title="Data Admin"
                    data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                    data-bs-placement="right">
                    <span class="menu-icon">
                        <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
            ...
            <div class="menu-item">
                <a class="menu-link" href="{{ route('admin.admin.users') }}" title="Data Admin"
                    data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                    data-bs-placement="right">
                    <span class="menu-icon">
                        <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
            ...
            <div class="menu-item">
                <a class="menu-link" href="{{ route('admin.logoutProcess') }}" title="SignOut"
                    data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                    data-bs-placement="right">
                    <span class="menu-icon">
                        <!--begin::Svg Icon | path: icons/duotune/coding/cod003.svg-->
