...
<head>
    ...
    <title>FAQ - Forstaff</title>
    <meta name="description" content="Pertanyaan yang sering ditanyakan seputar Aplikasi Forstaff.">
    <meta name="keywords" content="faq, informasi, hrd, staff">
    <meta name="revisit-after" content="2 days" />
    <meta name="robots" content="index, follow" />
    <meta name="rating" content="General" />
    <meta name="author" content="http://forstaff.id/" />
    <meta name="MSSmartTagsPreventParsing" content="true" />
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="reply-to" content="forstaff.id@gmail.com">
    <meta http-equiv="expires" content="Mon, 28 Jul 2025 11:12:01 GMT">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <link rel="apple-touch-icon" sizes="180x180"
        href="https://www.forstaff.id/assets/assets/img/fav/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32"
        href="https://www.forstaff.id/assets/assets/img/fav/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16"
        href="https://www.forstaff.id/assets/assets/img/fav/favicon-16x16.png">
    <link rel="mask-icon" href="https://www.forstaff.id/assets/assets/img/fav/safari-pinned-tab.svg" color="#fa7070">
    <meta name="msapplication-TileColor" content="#fa7070">
    <meta name="theme-color" content="#fa7070">
    <link rel="stylesheet" href="https://www.forstaff.id/assets/assets/css/base.min.css" type="text/css">
</head>

<body id="home-version-1" class="home-version-4" data-style="default"> <a href="#main_content"
                    ...
                    <nav class="site-nav">
                        ...
                        <div class="menu-wrapper" data-top="992">
                            <ul class="site-main-menu">
                                <li><a class="" href="{{ route('frontpage.beranda') }}">Beranda</a></li>
                                <li><a class="" href="{{ route('frontpage.fitur') }}">Fitur</a></li>
                                <li><a class="" href="{{ route('frontpage.tentang') }}">Tentang</a></li>
                                <li><a class="" href="{{ route('frontpage.harga') }}">Harga</a></li>
            ...
            <div class="container">
                <div class="tabs-wrapper">
                    <ul class="nav faq-tabs" role="tablist">
                        <li class="nav-item"> <a class="nav-link active" id="design-tab" data-toggle="tab"
                                href="#design" role="tab" aria-controls="design" aria-selected="true">UI/UX
                                Design</a> </li>
                        <li class="nav-item"> <a class="nav-link" id="service-tab" data-toggle="tab"
                                href="#servi\ce" role="tab" aria-controls="service"
                                aria-selected="false">Service</a> </li>
                        <li class="nav-item"> <a class="nav-link" id="general-tab" data-toggle="tab"
                                href="#general" role="tab" aria-controls="general"
                                aria-selected="false">General</a> </li>
                        <li class="nav-item"> <a class="nav-link" id="branding-tab" data-toggle="tab"
                                href="#branding" role="tab" aria-controls="branding"
                                aria-selected="false">Branding</a> </li>
                    </ul>
                            ...
                            <div id="accordionsing" class="faq faq-two pixFade">
                                <div class="card">
                                    <div class="card-header" id="heading10">
                                        <h5> <button class="btn btn-link collapsed" data-toggle="collapse"
                                                ...
                                                aria-controls="collapse00"> How to contact with Customer Service?
                                            </button> </h5>
                                    </div>
                                ...
                                <div class="card active">
                                    <div class="card-header" id="heading20">
                                        <h5> <button class="btn btn-link" data-toggle="collapse"
                                                data-target="#collapse10" aria-expanded="true"
                                                aria-controls="collapse10"> How delete my account? </button> </h5>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="heading30">
                                        <h5> <button class="btn btn-link collapsed" data-toggle="collapse"
                                                ...
                                                aria-controls="collapse20"> Where is the edit optioon on dashboard?
                                            </button> </h5>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="heading40">
                                        <h5> <button class="btn btn-link collapsed" data-toggle="collapse"
                                                ...
                                                aria-controls="collapse30"> Is there any custome pricing system?
                                            </button> </h5>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="heading42">
                                        <h5> <button class="btn btn-link collapsed" data-toggle="collapse"
                                                ...
                                                aria-controls="collapse32"> How can I track my orders? </button> </h5>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="heading43">
                                        <h5> <button class="btn btn-link collapsed" data-toggle="collapse"
                                                ...
                                                aria-controls="collapse33"> Where is the edit optioon on dashboard?
                                            </button> </h5>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="heading45">
                                        <h5> <button class="btn btn-link collapsed" data-toggle="collapse"
                                                ...
                                                aria-controls="collapse35"> Can I cancel or change my order? </button>
                                        </h5>
                                    </div>
                            ...
                            <div id="accordionsing-2" class="faq faq-two pixFade">
                                <div class="card active">
                                    <div class="card-header" id="heading101">
                                        <h5> <button class="btn btn-link collapsed" data-toggle="collapse"
                                                ...
                                                aria-controls="collapse001"> How to contact with Customer Service?
                                            </button> </h5>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="heading201">
                                        <h5> <button class="btn btn-link" data-toggle="collapse"
                                                data-target="#collapse101" aria-expanded="true"
                                                aria-controls="collapse101"> How delete my account? </button> </h5>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="heading301">
                                        <h5> <button class="btn btn-link collapsed" data-toggle="collapse"
                                                ...
                                                aria-controls="collapse201"> Where is the edit optioon on dashboard?
                                            </button> </h5>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="heading411">
                                        <h5> <button class="btn btn-link collapsed" data-toggle="collapse"
                                                ...
                                                aria-controls="collapse311"> Is there any custome pricing system?
                                            </button> </h5>
                                    </div>
                            ...
                            <div id="accordionsing-3" class="faq faq-two pixFade">
                                <div class="card active">
                                    <div class="card-header" id="heading102">
                                        <h5> <button class="btn btn-link collapsed" data-toggle="collapse"
                                                ...
                                                aria-controls="collapse002"> How to contact with Customer Service?
                                            </button> </h5>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="heading202">
                                        <h5> <button class="btn btn-link" data-toggle="collapse"
                                                data-target="#collapse102" aria-expanded="true"
                                                aria-controls="collapse102"> How delete my account? </button> </h5>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="heading302">
                                        <h5> <button class="btn btn-link collapsed" data-toggle="collapse"
                                                ...
                                                aria-controls="collapse202"> Where is the edit optioon on dashboard?
                                            </button> </h5>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="heading402">
                                        <h5> <button class="btn btn-link collapsed" data-toggle="collapse"
                                                data-target="#collapse302" aria-expanded="false"
                                                aria-controls="collapse302"> Is there any custome pricing system?
                                            </button> </h5>
                                    </div>
                            ...
                            <div id="accordionsing-4" class="faq faq-two pixFade">
                                <div class="card active">
                                    <div class="card-header" id="heading103">
                                        <h5> <button class="btn btn-link collapsed" data-toggle="collapse"
                                                data-target="#collapse003" aria-expanded="false"
                                                aria-controls="collapse003"> How to contact with Customer Service?
                                            </button> </h5>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="heading203">
                                        <h5> <button class="btn btn-link" data-toggle="collapse"
                                                ...
                                                aria-controls="collapse13"> How delete my account? </button> </h5>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="heading304">
                                        <h5> <button class="btn btn-link collapsed" data-toggle="collapse"
                                                data-target="#collapse204" aria-expanded="false"
                                                aria-controls="collapse204"> Where is the edit optioon on dashboard?
                                            </button> </h5>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="heading404">
                                        <h5> <button class="btn btn-link collapsed" data-toggle="collapse"
                                                data-target="#collapse304" aria-expanded="false"
                                                aria-controls="collapse304"> Is there any custome pricing system?
                                            </button> </h5>
                                    </div>
        ...
        <footer id="footer">
            <div class="container">
                    ...
                    <div class="row margin-top30">
                        <div class="col-lg-4 col-md-6">
                            <div class="widget footer-widget">
                                <h3 class="widget-title">Alamat Kami</h3>
                                <div class="info"> <strong>PT. Guna Teknologi Nusantara</strong> </div>
                                ...
                                <div class="info email"> <i class="ei ei-icon_mail_alt"></i>
                                    <span>info@redsystem.id</span> </div>
                                ...
                                <ul class="footer-social-link margin-top30">
                                    <li><a href="https://www.facebook.com/forstaff.id" title="Forstaff Apps"
                                            target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="https://www.twitter.com/forstaff.id" title="Forstaff Apps"
                                            target="_blank"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href="https://www.instagram.com/forstaff.id/" title="Forstaff Apps"
                                            target="_blank"><i class="fab fa-instagram"></i></a></li>
                                    <li><a href="https://www.linked.in/forstaff" title="Forstaff Apps"
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="widget footer-widget">
                                ...
                                <ul class="footer-menu">
                                    <li><a class="active" href="{{ route('frontpage.faq') }}">FAQ</a></li>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="widget footer-widget">
                                ...
                                <ul class="footer-menu">
                                    ...
                                    class="padding-store-3" width="140" height="44"> <img
                                    src="https://www.forstaff.id/assets/assets/img/app-store-badge.png"
                                    alt="Desktop dan mobile view" title="Desktop dan mobile view"
                                    class="padding-store-3" width="140" height="44">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="site-info wow pixFadeUp" data-wow-delay="0.3s">
                    <div class="copyright">
                        <p>© 2019 All Rights Reserved Design by <a href="#" target="_blank">Red
                                System</a> - PT. Guna Teknologi Nusantara</p>
                    </div>
                </div>
            </div>
        </footer>
