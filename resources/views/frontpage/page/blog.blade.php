...
<head>
    ...
    <title>Blog - Forstaff</title>
    <meta name="description" content="Blog Forstaff akan memberikan informasi terkait perkembangan dunia HRD.">
    <meta name="keywords" content="blog, informasi, hrd, staff">
                    ...
                    <nav class="site-nav">
                        ...
                        <div class="menu-wrapper" data-top="992">
                            <ul class="site-main-menu">
                                ...
                                <li><a class="current_page" href="{{ route('frontpage.blog') }}">Blog</a></li>
