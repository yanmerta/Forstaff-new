...
<head>
    ...
    <title>Fitur - Forstaff</title>
    <meta name="description"
        content="Aplikasi Forstaff memiliki fitur yang dapat mendorong bisnis anda untuk bisa menjadi AutoPilot dengan melakukan pengawasan yang baik terhadap karyawan yang anda miliki.">
    <meta name="keywords" content="fitur, solusi, autopilot, kpi, hrd, staff, statistic, report">
                    ...
                    <nav class="site-nav">
                        ...
                        <div class="menu-wrapper" data-top="992">
                            <ul class="site-main-menu">
                                ...
                                <li><a class="current_page" href="{{ route('frontpage.fitur') }}">Fitur</a></li>
            ...
            <div class="container">
                <div class="page-title-wrapper">
                    ...
                    <ul class="bradcurmed color-white">
                        <li><a href="https://www.forstaff.id/">Beranda</a></li>
                        <li>Fitur</li>
                    </ul>
                </div>
