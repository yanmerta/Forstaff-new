...
<head>
    ...
    <title>Kontak Kami - Forstaff</title>
    <meta name="description" content="Kami akan menjawab semua pertanyaan anda terkait aplikasi Forstaff.">
    <meta name="keywords" content="alamat, telepon, email, hrd, staff">
    ...
    <link rel="stylesheet" href="https://www.forstaff.id/assets/assets/css/kontak.min.css" type="text/css">
</head>
                    ...
                    <nav class="site-nav">
                        ...
                        <div class="menu-wrapper" data-top="992">
                            <ul class="site-main-menu">
                                ...
                                <li><a class="current_page" href="{{ route('frontpage.kontak') }}">Kontak Kami</a>
                                </li>
                            </ul>
                    ...
                    <div class="col-md-8">
                        <div class="contact-froms">
                            <form action="https://www.forstaff.id/kontak-kami/send-message" class="contact-form"
                                id="send_message" enctype="multipart/form-data" method="post"
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="widget footer-widget">
                                ...
                                <ul class="footer-menu">
                                    ...
                                    <li><a class="current_page" href="{{ route('frontpage.kontak') }}">Kontak
                                            Kami</a></li>
                                </ul>
                            </div>
                        </div>
